...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='crop', 
        ...
        if use_ref_video and ref_info == 'all':
            ...
            batch = get_data(first_coeff_path, audio_path, self.device, ref_eyeblink_coeff_path=ref_eyeblink_coeff_path, still=still_mode, idlemode=use_idle_mode, length_of_audio=length_of_audio, use_blink=True) # longer audio?
